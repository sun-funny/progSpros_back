...
from progSpros_back.model.db_models_ps import PSDATA, reference_models, FedState, Otrasl
...
class MapRF(Resource):
    def get(self):
        ...
        try:
            ...
            query = fo_otrasl_query(base_query, PSDATA, FedState, Otrasl, yearfrom, yearto)
