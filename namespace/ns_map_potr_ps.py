...
from progSpros_back.model.db_models_ps import PSDATA, reference_models, FedState, Contragent
...
@ns_map_potr_ps.route('/map_potr_ps')
@ns_map_potr_ps.response(200, 'Success')
@ns_map_potr_ps.doc(params={
...
class MapRF(Resource):
    def get(self):
        ...
        try:
            ...
            structure = {}
            results = query.all()
            structure = create_structure_fo('Карта по потребителям', 'potr_list', results, version_mapping, structure)
            ...
            ns_map_potr_ps.abort(*errorhandler(e))